...
if __name__ == '__main__':
    ...
    # モデル作成
    print("モデル作成開始")
    optimizer = tf.compat.v1.train.GradientDescentOptimizer(learning_rate=rnn_util.learning_rate)
    with tf.Graph().as_default():
        ...
        with tf.compat.v1.Session() as sess:
            ...
            rnn_util.calc_accuracy(X_test, Y_test, output_op, input_ph, supervisor_ph, istate_ph, sess, prints=True)
